...
namespace Capstone6TaskList.Controllers
{
    public class TasksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Description,DueDate,Complete,UserID,TaskID")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Description,DueDate,Complete,UserID,TaskID")] Task task)
        {
            if (ModelState.IsValid)
            {
